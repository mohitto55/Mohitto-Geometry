...
public static class PoissonDiscSampling
{
	...
	// public static List<Vector3> ThreeDPoints(float radius, Vector3 sampleRegionSize, int numSamplesBeforeRejection = 30)
	// {
	// 	// r^2 = x^2 + x^2
	// 	// r^2 = 2x^2
	// 	// x^2 = r^2 / 2
	...
	// 			Vector3 dir = new Vector3(Mathf.Sin(angle), Mathf.Cos(angle), Mathf.Cos(angle));
	// 			Vector3 candidate = spawnCentre + dir * Random.Range(radius, 2*radius);
	// 			if (IsValidThree(candidate, sampleRegionSize, cellSize, radius, points, grid)) {
	...
	// }
	//
	// static bool IsValidThree(Vector3 candidate, Vector3 sampleRegionSize, float cellSize, float radius, List<Vector3> points, int[,,] grid) {
	...
	// 	return false;
	// }
	// public static List<Vector2> SebastianGeneratePoints(float radius, Vector2 sampleRegionSize, int numSamplesBeforeRejection = 30) {
	// 	// r^2 = x^2 + x^2
	// 	// r^2 = 2x^2
	// 	// x^2 = r^2 / 2
	// 	// x = sqrt(r^2 / 2)
